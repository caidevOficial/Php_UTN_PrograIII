   ...
   <link rel="stylesheet" type="text/css" href="../css/estilo.css">
    ...
    <body>
      <div class="container">
            ...
            <div class="jumbotron">
                <h3 class="text-info">Pasaje de parametros por nombre en un array </h3>
                    <div class="well well-sm text-info">
                                  class cd
                                     ...
                                     public static function TraerUnCdAnioParamNombreArray($id,$anio) 
                                            {
                                                ...
                                                $consulta->execute(array(':id'=> $id,':anio'=> $anio);<br>
                                                $consulta->execute();<br>
                                    ...
                                    //utilización del método estatico<br>
                                       $unCd =cd::TraerUnCdAnioParamNombreArray(2,1990);<br>
             ...
             <h3 >  Método de la clase  </h3>
                                    ...
                                    include_once ("clases/cd.php");
                                     ...
                                     $unCd =cd::TraerUnCdAnioParamNombreArray(1,1990);

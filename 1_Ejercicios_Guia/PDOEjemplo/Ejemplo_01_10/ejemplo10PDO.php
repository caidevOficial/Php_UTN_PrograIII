                                  ...
                                  class cd
                                    {<br>
                                        ...
                                        {<br>
                                            ...
                                            $consulta =$objetoAccesoDato->RetornarConsulta("select  titel as titulo, interpret as cantante,jahr as año from cds  WHERE id=? AND jahr=?");<br>
                                            $consulta->execute(array($id, $anio));<br>
                                    ...
                                    //utilización del método estatico<br>
                                       $unCd =cd::TraerUnCdAnio(2,1990);<br>

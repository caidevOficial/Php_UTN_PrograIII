...
class Pizza{
    ...
    /**
     * Gets the information of the pizza as a string formated as a html table.
     * @return string The information of the pizza as a string formated as a html table.
     */
    public function getInformation(){
        $tableHeader = 
        "<table>
            <th>ID</th><th>Sabor</th><th>Precio</th><th>Tipo</th><th>Cantidad</th>
            <tr align='center'>";
        $tableBody = 
        "<td>".$this->getID()."</td>".
        "<td>".$this->getSabor()."</td>".
    ...
    public static function SearchFor($array, $sabor, $tipo){
        ...
        if($sTipo && $sSabor){
            ...
            echo 'Solo hay de tipo: '.$tipo.'<br>';
        }else if($sSabor){
            echo 'Solo hay de sabor: '.$sabor.'<br>';
        }else{
    ...
    public static function UpdateArray($pizza, $action):bool{
        ...
        if (!$pizza->pizzaInArray($arrayOfpizzas)) {
            if ($action == "add") {
                ...
                echo  "pizza not in existence, added.<br>";

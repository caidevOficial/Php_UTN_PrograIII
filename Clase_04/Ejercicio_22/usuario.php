<?php
    class Usuario{
        ...
        public static function GuardarJSON($filename="usuarios.json"):bool{
            $success = false;
            $users = array();
            try {
                $file = fopen($filename, "a+");
                if ($file) {
                    $users = Usuario::ReadCSV(str_replace(".json", ".csv", $filename));
        ...
        public static function ReadJSON($filename="usuarios.json"):bool{
            $success = false;
            $users = array();
            try {
                $file = fopen($filename, "r");
